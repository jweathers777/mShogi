////////////////////////////////////////////////////////////////////////////
// Name:         SymDynPatternPiece.cpp
// Description:  Implementation for class that represents a piece
//               type whose move can be represented with a symmetric 
//               dynamic bit pattern
// Created:      08/31/2004 02:44:55 Eastern Standard Time
...
//--------------------------------------------------------------------------
//       Class:  SymDynPatternPiece
//      Method:  ~SymDynPatternPiece
// Description:  Destroys this instance of a rook
//--------------------------------------------------------------------------
SymDynPatternPiece::~SymDynPatternPiece()
{
   vector<Bitboard*>::size_type direction;
   vector<Bitboard*>::size_type direction_count = mDirections.size();
   for (direction = 0; direction < direction_count; direction++) {
...
//--------------------------------------------------------------------------
bool SymDynPatternPiece::ThreatensSquare(Piece* piece, int square)
{
   bool finished = false;
   int firstblocker;
   vector<Bitboard*>::size_type direction;
...
//--------------------------------------------------------------------------
void SymDynPatternPiece::GenerateCaptures(std::vector<Move>& movelist, Piece* piece)
{
...
//--------------------------------------------------------------------------
void SymDynPatternPiece::GenerateNonCaptures(std::vector<Move>& movelist, Piece* piece)
{
