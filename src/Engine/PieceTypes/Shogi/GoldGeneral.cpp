////////////////////////////////////////////////////////////////////////////
// Name:         GoldGeneral.cpp
// Description:  Implementation for a class that represents a Gold General
...
//       Class:  GoldGeneral
//      Method:  GoldGeneral
// Description:  Constructs an instance of a gold general
//--------------------------------------------------------------------------
GoldGeneral::GoldGeneral(Board* board, int value, int typevalue)
{
   mpBoard = board; 
   mValue = value;
   ...
   mNotation = "G";
   mNames[0] = "Gold General"; mNames[1] = "Kinsho";
   mDescription = 
      "Moves 1 square in any direction except diagonally backwards";

   int finish;
   // Initialize the gold general's attack patterns
