...
impl MovePattern {
    pub fn from_str(name: &str) -> Option<Self> {
        match name {
            ...
            "any_direction" => Some(MovePattern::AnyDirection),
            ...
            "forward_one_diagonal_one_jump" => Some(MovePattern::ForwardOneDiagonalOneJump),
            ...
            "orthogonal_one_diagonal_one_jump" => Some(MovePattern::OrthogonalOneDiagonalOneJump),
